...
| [RC_RESEARCH/RC_PHASE3_MASTER_PLAN.md](RC_RESEARCH/RC_PHASE3_MASTER_PLAN.md) | 🏗️ PHASE 3 PLAN (2026-05-29) | **Manufacturing in India master plan.** 5-phase investment roadmap (3.0 OEM white-label → 3.1 first license → 3.2 multi-mold → 3.3 Koppal cluster → 3.4 80% MII + export). Total capital ₹4.4-6.7 Cr over 6 yrs to ₹100+ Cr run-rate. Synthesizes 5 parallel agents (global precedents, India landscape, licensing, plastic molding, components) |
| [RC_RESEARCH/RC_PHASE3_MOULDERS_BY_GEOGRAPHY.md](RC_RESEARCH/RC_PHASE3_MOULDERS_BY_GEOGRAPHY.md) | 🗺️ MFG INFRA (2026-05-30) | Indian plastic moulding ecosystem mapped by State → City → Cluster. 40+ companies. Tier 1 BLR call list (Komtech, Moldrite, Microplastics, Plasmotek, Shree Sampath). Karnataka 14 + Aequs Koppal cluster |
| [GLOBAL_RC_LICENSED_IP_COMPETITIVE_INTEL.md](GLOBAL_RC_LICENSED_IP_COMPETITIVE_INTEL.md) | 🌐 GLOBAL INTEL (2026-05-29) | Rastar / Hot Wheels / Maisto / Carrera / Jada / Welly / MJX deep dive. $30-50K MG for India-only licensed auto IP. 3 specific tactics to steal for Indian challenger |
...
| File | Status | What's In It |
|------|--------|-------------|
| [LANDING_PAGE/PANDAY_OPERATING_TERMS_V1.md](LANDING_PAGE/PANDAY_OPERATING_TERMS_V1.md) | 📜 CONTRACT v1 (2026-05-29) | Scope, payment, ownership, exit, IP for Panday engagement. 12 sections. ₹5,500/store × 5 stores = ₹27.5K base (per latest WhatsApp) + per-sale ₹10/unit RC bonus + ₹10K/mo retainer after 3 sites live |
| [LANDING_PAGE/PANDAY_COMPETITOR_BENCHMARK_RANKINGS.md](LANDING_PAGE/PANDAY_COMPETITOR_BENCHMARK_RANKINGS.md) | 🏆 BENCHMARK (2026-05-30) | 20 RC store competitors ranked by Reach + SEO + Sales + Conversion. Master composite + 4 sub-rankings. What to steal from each best-in-class (Daddy Drones reach, LoT conversion, Mirana funding, DeoDap wholesale). For Panday's site build reference |
